...
3. `git clone https://github.com/Shiv-sharma-111/Book-Record-Management.git`
...
1. Choose any open issue from [here](https://github.com/Shiv-sharma-111/Book-Record-Management/issues). 
